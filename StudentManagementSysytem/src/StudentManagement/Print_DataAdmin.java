...
class Print_DataAdmin implements ActionListener{
    JFrame f;
    ...
    String username,uid,fullname,contact,semester,branch,fee;
    JButton b1,b2;
    ImageIcon icon;

    Print_DataAdmin(String u){
        try{
            conn con = new conn();
            String str = "select * from alladmindata where username ='"+u+"'";
        ...
        id8 = new JLabel("Administrator`s Detail");
...
*/
    ...
    public static void main(String[] args){
        new Print_DataAdmin("Print_Data");
    }
